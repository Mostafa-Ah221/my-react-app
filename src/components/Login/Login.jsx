  ...
  return (
    <>
      ...
      <div className="py-6 max-x-xl mx-auto max-w-xl">
        ...
        <h2 className="text-green-800 font-bold text-2xl">Login Now</h2>
        <form onSubmit={formik.handleSubmit} className="my-5">
          ...
          <button type="submit" className="text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:outline-none focus:ring-green-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800">
            ...
            <p className='pl-4'>Did'n have accont yet? <span className='font-semibold'><Link to="/register">Register Now</Link></span> </p>
          </div>
        </form>
      </div>
    </>
